package com.example.bingo6.flaborfit;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadDetailActivity(String excerciseTitile){
        Intent intent =  new Intent(MainActivity.this, DetailsActivity.class);
        intent.putExtra(MainActivity.EXTRA_ITEM_TITLE, excerciseTitile);
